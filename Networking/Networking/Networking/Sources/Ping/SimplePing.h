...
/*! Initialise the object to ping the specified ip address.
 *  \param address The ip address of the host to ping; an IPv4 or IPv6 address contains (struct sockaddr)
 *      work here.
 *  \returns The initialised object.
 */
